...
WORKDIR /src
COPY ["Ivas.Transactions.Api.csproj", "Ivas.Transactions.Api/"]
RUN dotnet restore "Ivas.Transactions.Api/Ivas.Transactions.Api.csproj"

WORKDIR "/src/Ivas.Transactions.Api"
COPY . .
RUN dotnet build "Ivas.Transactions.Api.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "Ivas.Transactions.Api.csproj" \
...
Execute unit tests
```
    cd "Ivas.Transactions.Api/test/Ivas.Transactions.Api.Tests"
    dotnet test
```

Deploy application
```
    cd "Ivas.Transactions.Api/src/Ivas.Transactions.Api"
