using System;
using Babylon.Transactions.Api.Logging;
using Babylon.Transactions.Domain.Constants;
using Babylon.Transactions.Injection.Injector;
using Babylon.Transactions.Shared.Exceptions.Middleware;
...
namespace Babylon.Transactions.Api
{
    public class Startup
    {
        ...
        {
            Console.WriteLine($"Starting to configure services for Babylon Transactions API");
            ...
            if (IsDevEnvironment)
            {
                services.AddSwaggerGen(gen =>
                {
                    ...
                    {
                        Version = "v1",
                        Title = "Babylon Transactions API",
                        Description = "Babylon Transactions API to handle investment transactions and portfolios",
                    });
                });   
            }

            Console.WriteLine("Finished configuring services for Babylon Transactions API");
        }
